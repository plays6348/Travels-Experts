...
const navigation = {
  ...
  legal: [
    // { name: "Claim", href: "#" },
    { name: "Booking Conditions", href: "/booking-conditions" },
    { name: "Terms & Conditions", href: "/terms-conditions" },
  ],
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/euroholidaysuk",
      icon: (props) => (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/euroholidaysofficial",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export function Footer() {
  return (
    <footer className="bg-white mt-18" aria-labelledby="footer-heading">
      <h2 id="footer-heading" className="sr-only">
        Footer
      </h2>
      <div className="mx-auto max-w-7xl px-4 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 justify-between xl:gap-24">
          ...
          <div className="mt-16 grid md:grid-cols-4 grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
                ...
                <div className="mt-6 space-y-4">
                  {navigation.social.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="text-gray-400 flex gap-2 hover:text-primary"
                    >
            ...
            <div className="md:grid md:grid-cols-1 col-span-1 md:gap-8">
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold leading-6 text-gray-900">
                  Legal
                </h3>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500">
            &copy; 2024 {appName}, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
